...
@section('content')
	...
	<div class="container">
		<div class="row">
			<div class="who-we-are col-xs-12">
				<div class="image">
				...
				<div class="text">
					...
					<a href="#" title="Leer más sobre la historia de Peacock Animal Health">Leer más...</a>
				</div>
			</div>
		</div>
	</div>
			...
			<div class="col-xs-12 featured-products-container">
				<div class="product-item">
					...
					<div class="info">
						...
						<span class="icon-bovino">bovino</span>
						<a href="#" class="rojo">Ver detalle</a>
					</div>
				</div>
			</div>
		</div>
